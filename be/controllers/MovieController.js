  ...
  static async create(req, res) {
    try {
      const {
        ...
        actors,
        genres,
        trailer_urls, // Array of trailer URLs
        poster_url,
      } = req.body;

      // Create new movie with initial data and set approval_status to 1
      const movie = await Movie.create({
        ...
        countryId,
        poster_url,
        approval_status: 1, // Set approval status to 1 (approved)
        is_popular: false, // Default value, can be updated later
      });
